...
export const section11: Section = {
  ...
  questions: [
    ...
    {
      id: 176,
      text: "¿Con qué frecuencia revisáis vuestro presupuesto familiar?",
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "b) No, nos sentimos cómodos con nuestros hábitos actuales", value: "b", points: 3 },
        { label: "c) Solo si es muy necesario", value: "c", points: 2 },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "b) No tenemos una estrategia definida", value: "b", points: 3 },
        { label: "c) Confiamos en poder pedir ayuda si surge algún problema", value: "c", points: 2 },
    ...
    },
    {
      ...
      options: [
        { label: "a) Sí, estamos dispuestos a hacer los sacrificios necesarios", value: "a", points: 4 },
        { label: "b) No, no queremos sacrificar nuestro estilo de vida", value: "b", points: 3 },
        { label: "c) Solo si es absolutamente necesario", value: "c", points: 2 },
